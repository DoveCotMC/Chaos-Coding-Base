...
public class Test {
    public static void main(String[] args) {
        ObjLoader.load(new ModelIdentifier("ccb", "utah_teapot"), "model/teapot/teapot", new SystemFileProvider("C:\\Users\\admin\\Documents\\ChaosCodingBase\\1.20.1-fabric\\ChaosCodingBase\\src\\main\\resources\\assets\\ccb"));
    }
}
